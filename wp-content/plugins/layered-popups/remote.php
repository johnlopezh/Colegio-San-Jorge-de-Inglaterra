...
<ul>
	...
	<li>
		...
		<ul>
			...
			<li><code>only-once</code>. The popup is displayed only once.</li>
...
<ul>
	...
	<li><code>period</code>. Set period (in days) when <code>mode</code> is set as <code>once-period</code>. This parameter is ignored in all other cases.</li>
	<li><code>offset</code>. The popup is displayed when user scroll down to this number of pixels.</li>
</ul>
